        ...
        <div >
            ...
            <div className="searchItem">
                ...
                <div className="siDesc">
                    <h1 className="siTitle">{restaurant.name}</h1>
                    <span className="siDistance">{restaurant.distance}m from center</span>
                    <div className="flex gap-4 flex-wrap mt-6">
                    {restaurant.specification?.map((spec) => (
                ...
                <div className="siDetails">
                    ...
                    <div className="siDetailTexts">
                        ...
                        <Link to={`/restaurant/${restaurant._id}`} className="siCheckButton">See Availabilty</Link>
                    </div>
                </div>
            </div>
