        ...
        <div className="flex flex-col w-80 gap-8 bg-stone-100 shadow-md rounded-md">
            ...
            <div className="mx-4 mb-6">
                ...
                <div className="flex justify-between gap-4 mt-4">
                    <button onClick={() => setIsDateOpen(!isDateOpen)} className=" border-orange-400 text-orange-400 hover:text-orange-500 hover:border-orange-500 hover:bg-orange-200 border-solid border py-2 rounded-lg w-36 text-center transition duration-200 box-border">Availability</button>
                    <button onClick={() => navigate(`/room/${room._id}/book`)} className="bg-orange-400 hover:bg-#0071c2 py-2 rounded-lg w-36 text-center text-neutral-50  transition duration-200 font-semibold">Reserve</button>
                </div>
