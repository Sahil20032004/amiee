                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{booking?.room.pricePerDay} Rupees</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col items-center" >
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <textarea value={dates?.toString()} id="phone" rows={dates.length + 1} cols={10} className="py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono break-all resize-none" />
                                        </div>
                                        <div className="ml-8 flex mb-4">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{booking?.totalPrice} Rupees</span>
                                        </div>
                                        <div className="ml-8 flex mb-4">
