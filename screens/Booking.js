        ...
        <Fragment>
            ...
            <Fragment>
                {isLoading ? <Loader /> : (
                    <Fragment>
                        {!room ? <NotFound /> : (
                            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4 flex flex-col md:flex-row  md:justify-between "  id='container'>
                                <div className="flex flex-col items-center">
                                    <div className="px-1 sm:px-3" id='room'>
                                    ...
                                    <div className="px-1 sm:px-3" id='room'>
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{room?.pricePerDay} Rupees</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="px-1 sm:px-3">
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <button onClick={() => setIsDateOpen(!isDateOpen)}>
                                                <textarea value={dates?.toString()} disabled={true} id="phone" rows={dates.length + 1} cols={10} className="py-2 px-1 sm:px-2 rounded-md border border-solid border-gray-400 text-gray-700 font-mono cursor-pointer break-all resize-none hover:bg-orange-200 transition duration-200" />
                                            </button>
                                            <Modal disableAutoFocus={true} open={isDateOpen} onClose={() => setIsDateOpen(false)} className="flex justify-center items-center mb-20">
                                                <div className="flex flex-col bg-white pb-8 rounded-md">
                                                    <CloseIcon fontSize="large" onClick={() => setIsDateOpen(false)} className="rounded-full text-orange-500 cursor-pointer hover:bg-neutral-200 transition duration-200 p-1 m-2" />
                                                    <DateRange
                                        ...
                                        <div className="ml-8 flex mb-4">
                                            ...
                                            <span className="font-mono">{prices} Rupees</span>
                                        </div>
                                        <div className="ml-8 flex mb-4">
                                            <span className="font-medium inline-block  w-28">GST:</span>
                                            <span className="font-mono">{vat} Rupees</span>
                                        </div>
                                        <div className="ml-8 flex mb-4">
                                            <span className="font-medium inline-block w-28">Total Price:</span>
                                            <span className="font-mono">{totalPrice} Rupees</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="px-1 sm:px-3 py-20 flex justify-center sm:justify-end items-center " id='checkout'>
                                        <button onClick={onCheckout} className="py-4 w-60 block text-center rounded  hover:bg-orange-500 transition duration-200 text-zinc-50 " >Checkout</button>
                                </div>
                            </div >
                        )}
                    </Fragment>
