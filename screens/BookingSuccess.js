    ...
    return (
        <Fragment>
            ...
            <div className="flex flex-col justify-center items-center h-[calc(100vh-97px)]">
                ...
                <button className="bg-orange-400 hover:bg-orange-500 py-3 px-6 rounded text-green-50 transition duration-200" onClick={() => navigate('/me/bookings')}>Your Bookings</button>
            </div>
        </Fragment>
    )
}
